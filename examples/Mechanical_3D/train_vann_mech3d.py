...
torch.save(model, data_dir / f'Mechanical3D_models/vann_mech3D_{current_time}.pt')
fig.savefig(data_dir / f'Mechanical3D_models/vann_mech3D_training_history_{current_time}.png', dpi=300)
