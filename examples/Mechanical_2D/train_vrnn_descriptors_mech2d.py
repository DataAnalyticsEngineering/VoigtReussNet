...
train_data = SpinodoidMechanical2D(file_name=h5_file, mode = "descriptors", frequencies = [1,2,3,4,5], split = "train_set", 
...
val_data = SpinodoidMechanical2D(file_name=h5_file, mode = "descriptors", frequencies = [1,2,3,4,5], split = "val_set", 
...
torch.save(model, data_dir / f'Mechanical2D_models/spinodoids/test_descriptors/spinodoid_descriptors_vrnn_{current_time}.pt')
fig.savefig(data_dir / f'Mechanical2D_models/spinodoids/test_descriptors/spinodoid_descriptors_vrnn_training_history_{current_time}.png', dpi=300)
