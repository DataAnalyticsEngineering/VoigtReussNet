...
torch.save(model, data_dir / f'Mechanical2D_models/orthotropic_cholnn_{current_time}.pt')
fig.savefig(data_dir / f'Mechanical2D_models/orthotropic_cholnn_training_history_{current_time}.png', dpi=300)
