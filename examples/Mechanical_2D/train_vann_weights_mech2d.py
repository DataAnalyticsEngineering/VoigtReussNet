...
normalization = VanillaNormalization(dim=3)
...
torch.save(model, data_dir / f'Mechanical2D_models/spinodoids/spinodoid_weights_vann_{current_time}.pt')
fig.savefig(data_dir / f'Mechanical2D_models/spinodoids/spinodoid_weights_vann_training_history_{current_time}.png', dpi=300)
